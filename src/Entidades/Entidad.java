...
public abstract class Entidad {
    ...
    protected ArrayList<ArrayList<String>> eventosExtra;
    ...
    protected final ArrayList<ArrayList<String>> calcularInteraccionExtra(Jugador jugador, String id){
        ...
        ArrayList<ArrayList<String>> interaccionesExtra = BBDD.conectarBaseDatos(jugador, id);
        this.eventosExtra = interaccionesExtra;
