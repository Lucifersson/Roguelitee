...
public class GolemMusgo extends Entidad {
    ...
    public String interactuar(Jugador jugador, String seleccion) {
        ...
        switch (seleccion) {
            case "1. Empujarlo con todas tus fuerzas":
            ...
            case "2. Arrancarle un trozo de musgo":
