...
public class LuzBurlona extends Entidad {
    ...
    public String interactuar(Jugador jugador, String seleccion) {
        ...
        switch (seleccion) {
            case "1. Correr tras ella gritando":
            ...
            case "2. Acercarse a ver si ilumina un camino":
