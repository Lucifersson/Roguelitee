    ...
    public String interactuar(Jugador jugador, String seleccion) {
        switch (seleccion) {
            case "1. Darle un Fuerte Pisotón":
                ...
                return "El pisotón falla y tropiezas en el barro. Recibes **" + danoMax + " de daño** por esporas concentradas.";

            case "2. Pinchazo Rápido con un Dedo":
                jugador.reducirSalud(danoMin);
                return "Fallaste la precisión y te pinchas con una seta. Recibes **" + danoMin + " de daño** por veneno.";
